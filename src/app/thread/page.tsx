  ...
  return (
    <div className='thread'>
        <div className="thread-container">
            <div className="thread-container-top">
                <span className='thread-poster'>Peter</span>
                <h2 className='thread-title'>My cat ate my homework</h2>
            </div>
            <div className="thread-container-center">
            ...
            <div className="thread-container-bottom">
                <h3>Comments</h3>
                <div className="thread-container-bottom-comment">
